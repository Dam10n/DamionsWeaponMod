...
{
	public class WraithFuryP : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Firey stream");     //The English name of the projectile
		...
		public override void SetDefaults()
		{
			...
			aiType = ProjectileID.ImpFireball; //Bullet
		}
		...
		public override void Kill(int timeLeft)
		{
			...
			for (var k = 0; k < 7; k++)
			{
				Dust.NewDust(projectile.position + projectile.velocity, projectile.width, projectile.height, 6, projectile.oldVelocity.X * 0.2f, projectile.oldVelocity.Y * 0.2f);
			}
		}
	}
}